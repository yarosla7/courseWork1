...
public class Main {
    public static void main(String[] args) {
        ...
        employeeBook.addEmployee("Журавлев Алексей Андреевич", 4, 110_000);
        ...
        employeeBook.addEmployee("Носкова Ульяна Эдуардовна", 4, 112_000);
        ...
        employeeBook.printDepartmentAndFullNamesIn();
    }
}